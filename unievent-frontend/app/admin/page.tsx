...
export default function AdminDashboard() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<DeleteConfirm>({ type: null, id: null });
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-400">Manage users, events, and platform analytics</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">
                        You have full access to manage all users and events. Use the tabs above to
                        view and manage platform content. Exercise caution when deleting items as
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gray-900 border-b border-gray-700">
                        <tr>
                          {['Name', 'Email', 'College', 'Phone', 'Joined', 'Actions'].map((h) => (
                            <th
                              key={h}
                      ...
                      <tbody className="divide-y divide-gray-700">
                        {users.map((user) => (
                          <tr key={user.id} className="hover:bg-gray-900/50">
                            ...
                            <td className="px-4 py-3 text-gray-300">{user.college}</td>
                ...
                {events.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gray-900 border-b border-gray-700">
                        <tr>
                          {['Event Name', 'Category', 'Date', 'Created By', 'Actions'].map((h) => (
                            <th
                              key={h}
                              className="px-4 py-3 text-left text-sm font-semibold text-gray-300"
                            >
                      ...
                      <tbody className="divide-y divide-gray-700">
                        {events.map((event) => (
                          <tr key={event.id} className="hover:bg-gray-900/50">
                            ...
                            <td className="px-4 py-3 text-gray-300">{formatDate(event.date)}</td>
                            <td className="px-4 py-3 text-gray-300">{event.createdByName}</td>
                            <td className="px-4 py-3">
                              <button
                                onClick={() =>
